...
EXPORT_API_ANDROID_OR_IOS(Tensor) THSTensor_add(const Tensor left, const Tensor right, const Scalar alpha);

EXPORT_API_ANDROID_OR_IOS(void) THSTensor_add_(const Tensor left, const Tensor right, const Scalar alpha);

EXPORT_API_ANDROID_OR_IOS(Tensor) THSTensor_add_scalar(const Tensor left, const Scalar right, const Scalar alpha);

EXPORT_API_ANDROID_OR_IOS(void) THSTensor_add_scalar_(const Tensor left, const Scalar right, const Scalar alpha);
...
EXPORT_API_ANDROID_OR_IOS(int) THSTensor_allclose(const Tensor left, const Tensor right, double rtol, double atol, bool equal_nan);
...
EXPORT_API_ANDROID_OR_IOS(void) THSTensor_free(const Tensor tensor);
...
EXPORT_API_ANDROID_OR_IOS(Tensor) THSTensor_div(const Tensor left, const Tensor right, const char* rounding_mode);

EXPORT_API_ANDROID_OR_IOS(void) THSTensor_div_(const Tensor left, const Tensor right, const char* rounding_mode);

EXPORT_API_ANDROID_OR_IOS(Tensor) THSTensor_div_scalar(const Tensor left, const Scalar right, const char* rounding_mode);

EXPORT_API_ANDROID_OR_IOS(void) THSTensor_div_scalar_(const Tensor left, const Scalar right, const char* rounding_mode);

EXPORT_API(Tensor) THSTensor_dot(const Tensor left, const Tensor right);

EXPORT_API_ANDROID_OR_IOS(Tensor) THSTensor_einsum(const char* equation, const Tensor* tensors, const int length);
...
EXPORT_API_ANDROID_OR_IOS(Tensor) THSTensor_eq(const Tensor left, const Tensor right);

EXPORT_API_ANDROID_OR_IOS(void) THSTensor_eq_(const Tensor left, const Tensor right);

EXPORT_API_ANDROID_OR_IOS(Tensor) THSTensor_eq_scalar(const Tensor left, const Scalar right);

EXPORT_API_ANDROID_OR_IOS(void) THSTensor_eq_scalar_(const Tensor left, const Scalar right);

EXPORT_API_ANDROID_OR_IOS(int) THSTensor_equal(const Tensor left, const Tensor right);
...
EXPORT_API_ANDROID_OR_IOS(Tensor) THSTensor_eye(const int64_t n, const int64_t m, const int8_t scalar_type, const int device_type, const int device_index, const bool requires_grad);

EXPORT_API_ANDROID_OR_IOS(Tensor) THSTensor_eye_out(const int64_t n, const int64_t m, const Tensor out);

EXPORT_API_ANDROID_OR_IOS(void) THSTensor_fill_(const Tensor tensor, Scalar value);

EXPORT_API_ANDROID_OR_IOS(Tensor) THSTensor_flatten(const Tensor tensor, const int64_t start, const int64_t end);
...
EXPORT_API_ANDROID_OR_IOS(Tensor) THSTensor_indices(Tensor tensor);

EXPORT_API_ANDROID_OR_IOS(Tensor) THSTensor_index(Tensor tensor,
...
EXPORT_API_ANDROID_OR_IOS(Tensor) THSTensor_linspace(const double start, const double end, const int64_t steps, const int8_t scalar_type, const int device_type, const int device_index, const bool requires_grad);

EXPORT_API_ANDROID_OR_IOS(Tensor) THSTensor_logspace(const double start, const double end, const int64_t steps, double base, const int8_t scalar_type, const int device_type, const int device_index, const bool requires_grad);

EXPORT_API(Tensor) THSTensor_load(const char* location);

EXPORT_API_ANDROID_OR_IOS(Tensor) THSTensor_log(const Tensor tensor);

EXPORT_API_ANDROID_OR_IOS(void) THSTensor_log_(const Tensor tensor);
...
EXPORT_API_ANDROID_OR_IOS(Tensor) THSTensor_new(
    void* data,
    void (*deleter)(void*),
    const int64_t* sizes,
    const int szlength,
...
EXPORT_API_ANDROID_OR_IOS(Tensor) THSTensor_frombuffer(
    void* data,
    void (*deleter)(void*),
    const int64_t count,
...
EXPORT_API_ANDROID_OR_IOS(Tensor) THSTensor_newInt64(
    int64_t* data,
    void (*deleter)(void*),
    const int64_t* sizes,
    const int szlength,
...
EXPORT_API_ANDROID_OR_IOS(Tensor) THSTensor_newFloat16(
    float* rawArray,
    c10::Half* dataArray,
    void (*deleter)(void*),
    const int64_t* sizes,
...
EXPORT_API_ANDROID_OR_IOS(Tensor) THSTensor_newBFloat16(
    float* rawArray,
...
EXPORT_API_ANDROID_OR_IOS(Tensor) THSTensor_newInt8Scalar(int8_t data, const int device_type, const int device_index, bool requires_grad);

EXPORT_API_ANDROID_OR_IOS(Tensor) THSTensor_newByteScalar(char data, const int device_type, const int device_index, bool requires_grad);

EXPORT_API_ANDROID_OR_IOS(Tensor) THSTensor_newBoolScalar(bool data, const int device_type, const int device_index, bool requires_grad);

EXPORT_API_ANDROID_OR_IOS(Tensor) THSTensor_newFloat16Scalar(float data, const int device_type, const int device_index, bool requires_grad);

EXPORT_API_ANDROID_OR_IOS(Tensor) THSTensor_newBFloat16Scalar(float data, const int device_type, const int device_index, bool requires_grad);

EXPORT_API_ANDROID_OR_IOS(Tensor) THSTensor_newInt16Scalar(short data, const int device_type, const int device_index, bool requires_grad);

EXPORT_API_ANDROID_OR_IOS(Tensor) THSTensor_newInt32Scalar(int data, const int device_type, const int device_index, bool requires_grad);

EXPORT_API_ANDROID_OR_IOS(Tensor) THSTensor_newInt64Scalar(int64_t data, const int device_type, const int device_index, bool requires_grad);

EXPORT_API_ANDROID_OR_IOS(Tensor) THSTensor_newFloat32Scalar(float data, const int device_type, const int device_index, bool requires_grad);

EXPORT_API_ANDROID_OR_IOS(Tensor) THSTensor_newFloat64Scalar(double data, const int device_type, const int device_index, bool requires_grad);

EXPORT_API_ANDROID_OR_IOS(Tensor) THSTensor_newComplexFloat32Scalar(float real, float imaginary, const int device_type, const int device_index, bool requires_grad);

EXPORT_API_ANDROID_OR_IOS(Tensor) THSTensor_newComplexFloat64Scalar(double real, double imaginary, const int device_type, const int device_index, bool requires_grad);
...
EXPORT_API_ANDROID_OR_IOS(Tensor) THSTensor_ones(const int64_t* sizes, const int length, const int8_t scalar_type, const int device_type, const int device_index, const bool requires_grad);

EXPORT_API_ANDROID_OR_IOS(Tensor) THSTensor_ones_out(const int64_t* sizes, const int length, const Tensor out);

EXPORT_API_ANDROID_OR_IOS(Tensor) THSTensor_ones_like(const Tensor input, const int8_t scalar_type, const int device_type, const int device_index, const bool requires_grad);
...
EXPORT_API_ANDROID_OR_IOS(Tensor) THSTensor_permute(const Tensor tensor, const int64_t* sizes, const int length);
...
EXPORT_API_ANDROID_OR_IOS(Tensor) THSTensor_rand(const Generator gen, const int64_t* sizes, const int length, const int8_t scalar_type, const int device_type, const int device_index, const bool requires_grad);

EXPORT_API_ANDROID_OR_IOS(Tensor) THSTensor_rand_out(const Generator gen, const int64_t* sizes, const int length, const Tensor out);

EXPORT_API_ANDROID_OR_IOS(Tensor) THSTensor_rand_like(const Tensor input, const int8_t scalar_type, const int device_type, const int device_index, const bool requires_grad);
...
EXPORT_API_ANDROID_OR_IOS(Tensor) THSTensor_relu(const Tensor tensor);

EXPORT_API_ANDROID_OR_IOS(void) THSTensor_relu_(const Tensor tensor);

EXPORT_API_ANDROID_OR_IOS(Tensor) THSTensor_relu6(const Tensor tensor);

EXPORT_API_ANDROID_OR_IOS(void) THSTensor_relu6_(const Tensor tensor);
...
EXPORT_API_ANDROID_OR_IOS(int) THSTensor_requires_grad(const Tensor tensor);

EXPORT_API_ANDROID_OR_IOS(Tensor) THSTensor_reshape(const Tensor tensor, const int64_t* shape, const int length);
...
EXPORT_API_ANDROID_OR_IOS(Tensor) THSTensor_sigmoid(const Tensor tensor);

EXPORT_API_ANDROID_OR_IOS(void) THSTensor_sigmoid_(const Tensor tensor);
...
EXPORT_API_ANDROID_OR_IOS(Tensor) THSTensor_sub(const Tensor left, const Tensor right);

EXPORT_API_ANDROID_OR_IOS(void) THSTensor_sub_(const Tensor left, const Tensor right);

EXPORT_API_ANDROID_OR_IOS(Tensor) THSTensor_sub_scalar(const Tensor left, const Scalar right);

EXPORT_API_ANDROID_OR_IOS(void) THSTensor_sub_scalar_(const Tensor left, const Scalar right);

EXPORT_API_ANDROID_OR_IOS(Tensor) THSTensor_sum(const Tensor tensor, bool has_type, const int8_t dtype);

EXPORT_API_ANDROID_OR_IOS(Tensor) THSTensor_sum_along_dimensions(const Tensor tensor, const int64_t * dimensions, int length, bool keepdim, bool has_type, const int8_t dtype);
...
EXPORT_API_ANDROID_OR_IOS(int64_t) THSTensor_size(const Tensor tensor, const int64_t dim);

EXPORT_API_ANDROID_OR_IOS(void) THSTensor_sizes(const Tensor tensor, int64_t* (*allocator)(size_t length));
...
EXPORT_API_ANDROID_OR_IOS(Tensor) THSTensor_view(const Tensor tensor, const int64_t* shape, const int length);
...
//might rewrite later
EXPORT_API_ANDROID_OR_IOS(const char*) Tensor_Print(const Tensor tensor);
EXPORT_API_ANDROID_OR_IOS(const char*) Tensor_Dim(const Tensor tensor, int64_t *dim);
EXPORT_API_ANDROID_OR_IOS(const char*) Tensor_Shape(const Tensor tensor, int64_t *dims);
EXPORT_API_ANDROID_OR_IOS(const char*) Tensor_ToArray_Int(const Tensor a, int8_t dtype,  int *result);
EXPORT_API_ANDROID_OR_IOS(const char*) Tensor_ToArray_Int64(const Tensor a, int8_t dtype,  int64_t *result);
EXPORT_API_ANDROID_OR_IOS(const char*) Tensor_ToArray_Float(const Tensor a, int8_t dtype,  float *result);
EXPORT_API_ANDROID_OR_IOS(const char*) Tensor_ToArray_Float64(const Tensor a, int8_t dtype,  double *result);
...
{
    CATCH_RETURN_Tensor(at::Tensor input=torch::clamp(*tensor,0,6);at::Tensor clampedTensor=torch::relu(input);res=ResultTensor(clampedTensor));
}

void THSTensor_relu6_(const Tensor tensor)
{
    CATCH(torch::clamp_(*tensor,0,6);torch::relu_(*tensor););
}
