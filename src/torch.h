...
FUNCTION_ATTRIBUTE const char *Permute(Tensor a, int64_t *dims, int64_t dims_size, Tensor *result);
FUNCTION_ATTRIBUTE const char *AllClose(Tensor a, Tensor b, int64_t *result);
FUNCTION_ATTRIBUTE const char *Flatten(Tensor a, int64_t startDim, int64_t endDim, Tensor *result);
